...
# Elika Bozorgi <elika.bozorgi@uga.edu>
...
def createIndex (sess, nodeLabel, propName):
    ...
    cmd1 = "CREATE RANGE INDEX " + nodeLabel + "_" + propName + " IF NOT EXISTS FOR (n:"  + nodeLabel + ") ON (n." + propName + ")"
...
# Import Neo4J DB config data

n4j_db_conf = open("./neo4j_db_conf.json")
n4j_db_conf_js = json.load(n4j_db_conf)

host_n4j = n4j_db_conf_js['host']
port_n4j = n4j_db_conf_js['port']
usr_n4j = n4j_db_conf_js['usr']
pass_n4j = n4j_db_conf_js['pass']

# Creating neo4j database driver and session
# graph = Graph(uri='neo4j://localhost:7687', user="neo4j", password="password")
dbc = GraphDatabase.driver(uri = "bolt://" + "TCB722788.venture.terry.uga.edu" + ":" + str("7687"), auth=(usr_n4j, pass_n4j))
logger.debug("")
